...
public class BacklogRepositoryInfo {
    ...
    public BacklogRepositoryInfo setApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public BacklogRepositoryInfo setProjectKey(String projectKey) {
        this.projectKey = projectKey;
        return this;
    }

    public BacklogRepositoryInfo setSpaceId(String spaceId) {
