 ...
 * @author junichi11
 */
public class BacklogIssueStatusProvider implements IssueStatusProvider<BacklogRepository, BacklogIssue> {
    ...
    @Override
    public Collection<BacklogIssue> getUnsubmittedIssues(BacklogRepository repository) {
        // TODO
        return Collections.emptyList();
    }

    @Override
    public void discardOutgoing(BacklogIssue issue) {
    }

    @Override
    public boolean submit(BacklogIssue issue) {
        // TODO
        return false;
    }
    ...
    @Override
    public void addPropertyChangeListener(BacklogIssue issue, PropertyChangeListener lisntener) {
        issue.addPropertyChangeListener(lisntener);
    }
